...
namespace University1.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(University1Context context)
        {
            _context = context;
        }

        // GET: Students
        public async Task<IActionResult> Index(string StudentName,string StudentIDs)
        {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var student = await _context.Student.Include(s => s.Courses).ThenInclude(s => s.Course)
